...
const ButtonScreen: React.FC<ButtonScreenProps> = ({ navigation }) => {
    ...
    const buttons = [
        ...
        { name: 'Escareação', description: 'Processo de escareação', image: 'https://plus.unsplash.com/premium_photo-1661349604450-611c45c8c42f?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', route: 'EscareacaoScreen' },
