...
type Props = NativeStackScreenProps<RootStackParamList, 'Orbicushion'>;

export default function Orbicushion({ navigation }: Props) {
    ...
    const handleNotDoneConfirm = () => {
        ...
        navigation.navigate('Orbicushion'); // Volta para a tela de Orbicushion
    };
