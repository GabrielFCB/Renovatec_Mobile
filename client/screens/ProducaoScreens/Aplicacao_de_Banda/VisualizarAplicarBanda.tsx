...
type VisualizarAplicarBandaNavigationProp = StackNavigationProp<
    RootStackParamList,
    "AplicarBandaScreen"
>;

type Props = {
    navigation: VisualizarAplicarBandaNavigationProp;
};

const VisualizarAplicarBanda: React.FC<Props> = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>Pneus - Aplicacao de Banda</Text>
...
export default VisualizarAplicarBanda;
